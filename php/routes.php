...
return function (SlimApp $app) {
    ...
    $app->group('/admin', function () {
        ...
        // next-config //next主题添加以下内容
        $this->group('/next', function () {
            $this->get('/config',       App\Controllers\Admin\NextController::class . ':nextConfig');
            $this->put('/config/update/{key}',       App\Controllers\Admin\NextController::class . ':update');
        });
        //next主题添加以上内容
    })->add(new Admin());
